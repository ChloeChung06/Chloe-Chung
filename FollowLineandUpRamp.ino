...
#define MOTOR_A_EN 3   // Enable pin for Motor A (must be PWM)
#define MOTOR_A_IN1 2  // Direction pin 1 for Motor A
#define MOTOR_A_IN2 1  // Direction pin 2 for Motor A
#define MOTOR_B_EN 11    // Enable pin for Motor B (must be PWM)
...
void loop() {
  ...
  GyroZ = GyroZ - GyroErrorZ;  // GyroErrorX ~(-0.56)
